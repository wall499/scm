...
<table width="100%" border="0" cellpadding="0" cellspacing="2">
	<tr><td colspan="3" align=center>${month}入库主信息</td></tr>
	<tr>
    <td class="title1">入库单据数</td>
    <td class="title1">产品总数量</td>
	<td class="title1">入库产品总金额</td>
	</tr>
	<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
	<tr><td colspan="6" align=center>${month}入库详细列表</td></tr>
	<tr>
